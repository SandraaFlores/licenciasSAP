			...
			<div class="card shadow">
				<div class="card">
					<div class="card-header col-sm-12">
						<div>
							<img
								src="<?= base_url('assets/images/optima.png" alt="Optima" width="200" height="70"') ?>"/>
						</div>
						<div class="col-sm-6 mx-auto">
							<h5>Solicitar licencias en platafoma SAP.</h5>
						...
						<form class="needs-validation" method="post"
							...
							<div class="form-group row mx-0">
								...
								<div class="col-lg-3 p-0">
									<select id="system" name="system"
											class="form-control <?php echo empty(form_error('system')) ? "" : "is-invalid"; ?>"
											autofocus>
							...
							<div class="form-group row mx-0">
								...
								<textarea id="justification" name="justification" rows=" 4" cols="10"
										  ...
										  class="form-control <?php echo empty(form_error('justification')) ? "" : "is-invalid"; ?>"
							...
							<div class="form-group row mx-0 autocomplete">
								...
								<label class="col-lg-2 col-form-label form-control-label" for="types_of_user">Tipo de
									usuario:</label>
								<div class="col-lg-3 p-0">
									<select id="types_of_user" name="types_of_user"
											class="form-control <?php echo empty(form_error('types_of_user')) ? "" : "is-invalid"; ?>">
							...
							<div class="button form-group">
								<div class="center">
									<button type="submit" class="btn btn-info btn-small" id="submit" name="submit">
										Guardar
									</button>
								</div>
							</div>
